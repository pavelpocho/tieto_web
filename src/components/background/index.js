...
export default class Background extends Component {
    ...
    loginAction() {
        ...
        if (ObjectContainer.isDarkTheme()) {
            ...
            this.shape.current.style.fill = "#191919";
            ...
            <Fragment>
                ...
                <div ref={this.logoWrap} id="background-logo-wrap">
                    <svg id="background-logo-background-wrap">
                        ...
                        <polygon id="background-logo-background" className={ObjectContainer.isDarkTheme() ? "dark" : ""} points="0,0 215,0 108,109 0,86" filter="url(#f1)"/>
                    </svg>
                    <Logo />
                </div>
