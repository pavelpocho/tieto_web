        ...
        return (
            <div className="loader" ref={this.ref}>
                <svg className="circular-loader" viewBox="25 25 50 50" >
                    <circle className="loader-path" cx="50" cy="50" r="20" fill="none" stroke={this.props.color == "white" ? (ObjectContainer.isDarkTheme() ? "black" : "white") : (ObjectContainer.isDarkTheme() ? "#1C6D9E" : "#62B3E4")} strokeWidth={this.props.size < 50 ? "6" : "3"} />
                </svg>
            </div>
        )
    }
